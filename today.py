...
USER_NAME = os.environ['USER_NAME'] # 'tylermong'
...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    tspan[58].firstChild.data = star_data
    tspan[60].firstChild.data = follower_data
    tspan[62].firstChild.data = loc_data[2]
    tspan[63].firstChild.data = loc_data[0] + '++'
    tspan[64].firstChild.data = loc_data[1] + '--'
...
if __name__ == '__main__':
    """
    Tyler Mong (tylermong), 2022-2024
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 2, 28))
    ...
    if OWNER_ID == {'id': 'U_kgDOBvrSmw'}: # only calculate for user tylermong
